...
const colorLabelSchema = new mongoose.Schema({
  labelMasterId: { type: mongoose.Schema.Types.ObjectId, ref: "ColorLabelMaster", index: true },
  ...
  jobType: { type: String, default: "COLOR" },
  jobName: { type: String },
...
const ColorLabel = mongoose.models.ColorLabel ||
  mongoose.model("ColorLabel", colorLabelSchema, "colorlabelsbinding");
